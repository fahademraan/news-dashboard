            ...
            <div class="row mx-0">
                <div class="col-12 col-md-8 col-lg-10">
                        ...
                        <div class="card w-100 bg-light">
                            <div class="h-100 p-2 bg-light-pink">
                                <ul class="ps-0">
                                    ...
                                    <li class="list-item mb-3 list-style-none"><i
                                            class="fa-solid fa-circle-check text-black"></i>text-black Change the price or your
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="sellerHome.php" class="btn bg-sidebar"><i class="fa-solid fa-arrow-right"></i>
                            Finish</a>
                    </div>
                </div>
