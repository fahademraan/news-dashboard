...
<body class="bg-light">
    ...
    <div class="container">
        <div class="mar-border py-5 p-4 text-center bg-white w-lg-50 mx-auto shadow">
            <h1 class="display-4 fw-bold text-green my-4">Create Account</h1>
            <div class="mb-3">
            ...
            <div class="my-5">
                <button class="btn bg-green text-white w-50">Create Account</button>
            </div>
            <div class="d-flex justify-content-between">
                <a href="sellerlogin.php" class="btn btn-outline-secondary hover text-black">Go to Login</a>
